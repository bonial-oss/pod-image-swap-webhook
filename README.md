...
[![Build Status](https://github.com/bonial-oss/pod-image-swap-webhook/actions/workflows/ci.yml/badge.svg)](https://github.com/bonial-oss/pod-image-swap-webhook/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/bonial-oss/pod-image-swap-webhook)](https://goreportcard.com/report/github.com/bonial-oss/pod-image-swap-webhook)
![License](https://img.shields.io/github/license/bonial-oss/pod-image-swap-webhook)
...
helm repo add pod-image-swap-webhook \
  https://bonial-oss.github.io/pod-image-swap-webhook
```
...
[`config.sample.yaml`](https://github.com/bonial-oss/pod-image-swap-webhook/blob/main/config.sample.yaml).
For more helm configuration options have a look into the [`values.yaml`
defaults](https://github.com/bonial-oss/pod-image-swap-webhook/blob/main/charts/pod-image-swap-webhook/values.yaml).
